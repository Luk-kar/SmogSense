...
# 2. Give permission to execute this script: chmod +x run_tests.sh
...
REQUIREMENTS_FILE="$SCRIPT_DIR/../src/data_acquisition/air_quality/requirements.txt"
...
poetry run python -m unittest discover -s "$SCRIPT_DIR/test_data_acquisition/test_air_quality" -p "*.py"

# Restore the original PYTHONPATH
export PYTHONPATH="$ORIGINAL_PYTHONPATH"

# Exit the shell (This happens automatically after the script finishes)
